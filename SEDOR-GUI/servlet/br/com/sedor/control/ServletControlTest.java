...
import br.com.sedor.test.SedorTest;


/**
 * Servlet implementation class ServletControlTest
 */
@WebServlet("/ServletControlTest")
public class ServletControlTest extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ServletControlTest() {
		super();
	}
		...
		try {
			...
			for (FileItem item : items) {
				if (item.isFormField()) {
					...
					try {
						SedorTest.test(resource.toString());
